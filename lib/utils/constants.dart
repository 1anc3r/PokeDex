...
class Constants {
  ...
  static const String POKEMON_TYPE_ICON_PRE_URL = 'assets/icons/20px-LPLE_';
  static const String POKEMON_LQ_IMG_URL =
      'https://play.pokemonshowdown.com/sprites/gen5/';
  static const String POKEMON_WIKI = 'https://wiki.52poke.com/';
  static const String POKEMON_HQ_IMG_URL = '${POKEMON_WIKI}/wiki/File:';
  static const String POKEMON_INDEX_URL = '${POKEMON_WIKI}/index.php';
  static const String POKEMON_CN_LIST_URL =
  ...
  static const Map<String, Color> POKEMON_COLOR_MAP = {
    '一般': Color(0xFF9199A1),
    '格斗': Color(0xFFCD406A),
    '飞行': Color(0xFF8EA8DE),
    '毒': Color(0xFFA96AC8),
  ...
  static const Map<int, double> POKEMON_GENDER_CODE_MAP = {
    256: -2.0,
    255: -1.0,
    254: 0.0,
    223: .125,
